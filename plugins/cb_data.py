...
async def doc(bot,update):
     ...
     ms = await update.message.edit("``` 𝐓𝐑𝐘𝐈𝐍𝐆 𝐓𝐎 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 ```")
     c_time = time.time()
     try:
     	path = await bot.download_media(message = file, progress=progress_for_pyrogram,progress_args=( "``` 𝐓𝐑𝐘𝐈𝐍𝐆 𝐓𝐎 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 ```",  ms, c_time   ))
     ...
     if thumb:
     		...
     		c_time = time.time()
     		await ms.edit("``` 𝐓𝐑𝐘𝐈𝐍𝐆 𝐓𝐎 𝐔𝐏𝐋𝐎𝐀𝐃 ```")
     		c_time = time.time()
     		try:
